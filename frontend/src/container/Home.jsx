    ...
    <>
      <div className="w-screen h-screen flex items-start justify-start overflow-hidden">
        ...
        <div className='flex-1 min-h-screen max-h-screen overflow-y-scroll h-full flex flex-col items-start justify-start'>
          {/* Top horizontal bar */}
          <div className='py-3 px-3 bg-black flex justify-between items-center w-full'>
            {/* Searchbar */}
            <div className="bg-slate-800 px-3 py-1 rounded-md flex items-center justify-center">
            ...
            <div className='flex gap-3'>
              ...
              <Link className="text-white bg-gray-600 px-5 py-2 rounded-md hover:bg-slate-500">
                Log In
              </Link>
            </div>
          </div>
